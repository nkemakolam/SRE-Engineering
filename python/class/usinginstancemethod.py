...
class Rectangle:
    def __init__(self, width,height):
         self.width = width
         self.height = height
# Pythonic way of applying gethher and setter is to the use instance method
# This a better approach to implement a getter and a setter 
    @property
    def width(self):
      return self._width
    ...
    # this is close to what we call overloading in other programming language  
    @width.setter
